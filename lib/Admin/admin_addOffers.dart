...
class AddOffersPage extends StatefulWidget {
  @override
  _AddOffersPageState createState() => _AddOffersPageState();
}
...
class _AddOffersPageState extends State<AddOffersPage> {
  ...
  Future<void> addSubcategory() async {
    ...
    try {
      ...
      // Add text fields
      request.fields['percentage'] = offer;
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['message'] == 'Offer Added successfully') {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please enter offer detail';
                  }
                  return null;
                },
              ),
