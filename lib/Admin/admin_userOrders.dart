...
class AdminUserorders extends StatefulWidget {
  const AdminUserorders({Key? key}) : super(key: key);

  @override
  State<AdminUserorders> createState() => _AdminUserordersState();
}

class _AdminUserordersState extends State<AdminUserorders> {
  ...
  Future<void> fetchOrders() async {
    try {
      ...
      final url = Uri.parse(
          "${Appconfig.baseurl}api/user_order_list.php?user_id=$userId");
